...
if __name__ == "__main__":
    ...
    incident_x = np.arange(0.05, 8.0, 0.5)
    incident_angles = []
    args = []
    ...
    np.savetxt('data/efficiencies_1M_many.csv', np.column_stack((incident_x, np.array(incident_angles), np.array(efficiencies))), delimiter=',')
